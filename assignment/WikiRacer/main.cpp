...
int numCommonLinks(const unordered_set<string>& curr_set, const unordered_set<string>& target_set) {
    ...
    auto inTargetSet = [&target_set](string s) { return target_set.find(s) != target_set.end(); };
    return std::count_if(curr_set.begin(), curr_set.end(), inTargetSet); 
}
...
vector<string> findWikiLadder(const string& start_page, const string& end_page) {
    ...
    auto cmp_fn = [&w, &target_set](const vector<string>& left, const vector<string>& right) {
        // replace all of these lines.
        return numCommonLinks(w.getLinkSet(left.back()), target_set) < numCommonLinks(w.getLinkSet(right.back()), target_set); // replace this line! make sure to use numCommonLinks.
    };
    // END STUDENT CODE HERE
    ///////////////////////////////////////////////////////////////////////////////////////////////////
